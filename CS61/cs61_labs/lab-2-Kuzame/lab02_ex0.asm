...
; 	^^ store 'H in an address labelled MSG_TO_PRINT and then each character
;	('e', 'l', 'l', 'o', ' ', 'w', ...) in it's own (consecutive) memory
;	address, followed by #0 at the end of the string to mark the end of the
;	string
